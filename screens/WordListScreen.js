      ...
      >
        ...
        >
          <View style={styles.detailCard}>
            ...
            <TouchableOpacity style={styles.tagButton} onPress={() => setActiveWord(null)}>
              <Text style={styles.tagButtonText}>Daily vocab</Text>
            </TouchableOpacity>
          </View>
        </TouchableOpacity>
      </Modal>
...
const styles = StyleSheet.create({
  ...
  info: { marginBottom: 8, padding: 12, backgroundColor: '#FFFFFF', borderRadius: 8 },
  ...
  listItem: { paddingVertical: 15, paddingHorizontal: 10, borderBottomWidth: 1, borderColor: '#ccc' },
  ...
  addButtonText: { color: '#fff', fontSize: 38, fontWeight: 'bold' },
  modalOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.4)', justifyContent: 'center', alignItems: 'center' },
  detailCard: { width: '85%', backgroundColor: '#d1f0f7', borderRadius: 15, padding: 30, alignItems: 'center' },
  detailEnglish: { fontSize: 40, fontWeight: 'bold', color: '#000', marginBottom: 5 },
  detailPhonetic: { fontSize: 22, color: '#333', marginBottom: 10 },
  detailJapanese: { fontSize: 36, fontWeight: '700', color: '#000', marginBottom: 20 },
  exampleBox: { borderStyle: 'dashed', borderWidth: 1.5, borderColor: '#4a90e2', padding: 10, borderRadius: 5, marginBottom: 20 },
  exampleText: { fontSize: 18, color: '#000', textAlign: 'center' },
  tagButton: { borderWidth: 1.5, borderColor: '#000', borderRadius: 20, paddingHorizontal: 20, paddingVertical: 5 },
  tagButtonText: { fontSize: 18, fontWeight: '600' },
});